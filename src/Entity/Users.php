...
class Users implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    // #[Assert\NotBlank]
    #[Assert\Length(min: 6, max: 20, minMessage: 'Username should be at least {{ limit }} characters', maxMessage: 'Username should not be longer than {{ limit }} characters')]
    ...
    // // the validation of password should not be here, It is always in the formType!

    #[ORM\Column(length: 50, nullable: true)]
    // #[Assert\NotBlank]
    #[Assert\Length(min: 3, max: 50, minMessage: 'Firstname should be at least {{ limit }} characters', maxMessage: 'Firstname should not be longer than {{ limit }} characters')]
    private ?string $firstname = null;

    #[ORM\Column(length: 100, nullable: true)]
    #[Assert\NotBlank]
    #[Assert\Length(min: 3, max: 50, minMessage: 'Lastname should be at least {{ limit }} characters', maxMessage: 'Lastname should not be longer than {{ limit }} characters')]
